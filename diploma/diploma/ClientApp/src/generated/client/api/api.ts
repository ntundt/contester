...
export const APIS = [AttemptService, AuthenticationService, ContestService, OidcConfigurationService, ProblemService, SchemaDescriptionService, ScoreboardService, UserService];

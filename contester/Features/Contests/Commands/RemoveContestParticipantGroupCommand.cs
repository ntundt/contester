...
public class RemoveContestParticipantGroupCommand : IRequest<ContestDto>, IAuthorizedRequest
{
...
public class RemoveContestParticipantGroupCommandHandler(
    ApplicationDbContext context,
    IMapper mapper,
    ScoreboardUpdateNotifier notifier,
    IUserGroupService userGroupService,
    IScoreboardService scoreboardService)
    : IRequestHandler<RemoveContestParticipantGroupCommand, ContestDto>
{
    public async Task<ContestDto> Handle(RemoveContestParticipantGroupCommand request, CancellationToken cancellationToken)
    {

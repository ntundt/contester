...
namespace contester.Migrations
{
    ...
    [Migration("20260627153518_MakeGroupsManyToMany")]
    partial class MakeGroupsManyToMany
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContestParticipantGroups", b =>
                {
                    b.Property<Guid>("ContestId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("ContestId", "ParticipantGroupsId");

                    b.HasIndex("ParticipantGroupsId");

                    b.ToTable("ContestParticipantGroups");
                });
            ...
            modelBuilder.Entity("ContestParticipants", b =>
                {
                    ...
                    b.Property<Guid>("ParticipantUsersId")
                        .HasColumnType("uuid");

                    b.HasKey("ContestsUserParticipatesInId", "ParticipantUsersId");

                    b.HasIndex("ParticipantUsersId");
            ...
            modelBuilder.Entity("ContestParticipants", b =>
                {
                    ...
                    b.HasOne("contester.Features.Users.User", null)
                        .WithMany()
                        .HasForeignKey("ParticipantUsersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
